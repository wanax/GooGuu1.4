...
@interface FinanceDataViewController : UIViewController<UIWebViewDelegate,CPTBarPlotDataSource,CPTBarPlotDelegate,ModelClassGrade2Delegate,CPTAxisDelegate>{
    //x轴起点
    float XRANGEBEGIN;
    //x轴在屏幕可视范围内的范围
    float XRANGELENGTH;
...
@property (nonatomic,retain) NSString *xAxisUnitPrefix;
@property (nonatomic,retain) NSDictionary *grade2Dic;
@property (nonatomic,retain) NSMutableArray *grade2BtList;
