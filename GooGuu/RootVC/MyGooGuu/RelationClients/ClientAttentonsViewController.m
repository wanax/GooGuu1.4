//
//  ClientAttentonsViewController.m
//  GooGuu
//
...
@implementation ClientAttentonsViewController
...
-(void)getClients:(NSString *)strOffset {
    ...
    [Utiles getNetInfoWithPath:@"ClientAttentions" andParams:params besidesBlock:^(id obj) {
